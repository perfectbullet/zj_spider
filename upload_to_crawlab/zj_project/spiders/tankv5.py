...
class TankSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        performence_and_power_overview = response.xpath('/html/body/div[9]/div/div[2]/div[1]/span[1]/text()').extract_first()
        ...
        structure_2 = '||'.join( [s.extract() for s in response.xpath('/html/body/div[11]/div/div[2]/div[2]/span/text()')])
