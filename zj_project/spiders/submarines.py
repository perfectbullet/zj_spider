...
class MySpider(scrapy.Spider):
    ...
    # english version
    start_urls = ['https://{}/wiki/Category:Submarines'.format(allowed_domains[0])]
    ...
    def parse(self, response):
        ...
        for cl in category_urls:
            if re.search(r'Submarine|submarine', cl) and re.search(r'Category', cl):
    ...
    def parse_category(self, response):
        ...
        for cl in new_categories:
            if re.search('Category', cl) and re.search('Submarine|submarine', cl):
